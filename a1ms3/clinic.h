...
// Todo:
void viewAllAppointments(struct ClinicData*);

// View appointment schedule for the user input date
// Todo:
void viewAppointmentSchedule(struct ClinicData*);
...
void SortAppointments(struct Appointment*);
